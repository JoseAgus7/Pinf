    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_genre', models.CharField(blank=True, choices=[('terror', 'Terror'), ('comedia', 'Comedia'), ('ciencia_ficcion', 'Ciencia Ficción'), ('aventura', 'Aventura'), ('documentales', 'Documentales'), ('musicales', 'Musicales'), ('romance', 'Romance'), ('otros', 'Otros')], max_length=50)),
